  ...
  return (
    <section className="flex flex-col bg-indigo-900 mx-auto mt-10 pt-2 pb-3 px-3 w-96 rounded-2xl md:mt-0 text-white">
      <div className="flex justify-between">
        <p className="p-2 font-bold">Swap</p>
      ...
      <div>
        <div className="bg-blue-950 rounded-2xl p-4">
          ...
          <div className="flex justify-end">
            <Input
              type="number"
              placeholder="0"
              className="bg-transparent text-right border-none text-3xl w-4/6"
            />
          </div>
        </div>
        ...
        <div className="p-4 border-slate-500 border-y border-x rounded-2xl mt-2">
          <p>You receive</p>
          <div className="flex justify-end">
            <Input
              type="number"
      ...
      <div className="mt-6">
        {walletConnected ? (
          ...
          <Button variant="secondary" className="w-full flex gap-2 rounded-xl">
            <svg
              className="w-4 h-4"
              viewBox="0 0 24 24"
              fill="none"
